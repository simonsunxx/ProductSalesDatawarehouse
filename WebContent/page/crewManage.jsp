...
%>
<jsp:useBean id="User_Mgr" class="entity.User_Mgr" scope="application"/>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="page/saleAnalysisScatter">散点图分析</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <%
                                    java.util.HashMap<Integer,User> map=new java.util.HashMap<Integer,User>();
                                    User_Mgr um=new User_Mgr();
                                    map=um.getUserList();
                                    java.util.Iterator it=map.keySet().iterator();                                   
                                    while(it.hasNext())
                                    {
                                    	User u=(User)map.get(it.next());
                                    	//System.out.println(sfh.getCHANNEL_ID());                                   	
                                    	String permission_name="";
                                    	String operation="";
                                    	if(u.getUser_permission()==1)
                                    	{
                                    		permission_name="管理权限";
                                    	}
                                    	else 
                                    	{
                                    		permission_name="普通权限";
                                    		operation="编辑";
                                    	}
                                    ...
                                    %>
                                     <tr class="gradeA">
                                            ...
                                            <td><a href="page/editUser.jsp?userid=<%=u.getUser_id()%>"><%=operation %></a></td>
                                        </tr>
                                        <%} %>
                                    </tbody>
                                </table>
