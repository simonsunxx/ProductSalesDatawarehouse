    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand waves-effect waves-dark" href="main.jsp"><i class="large material-icons">normal_saleAnalysis</i> <strong>Analysis</strong></a>
